...
registerExercises('fisica1-utn', '1', [
  ...
  {st: 'En los finales corregidos que hay en el material, la grilla de arriba tiene un casillero por problema (1 a 6) con una letra adentro (B, R, M, B/R). ¿Qué consecuencia táctica tiene eso?',
   ...
   ex: 'En los parciales de Martinelli la grilla llegaba a tener casillero por inciso a) y b) — es el formato de toda la serie 2010-2017, no de un año suelto. En el final <b>ese desglose se perdió</b>: hay un casillero por problema y adentro va una calificación cualitativa. Con esa grilla, un problema planteado a medias no se lleva medio casillero — se lleva una R o una M. Por eso la aritmética del 50% se cumple mejor con <b>tres completos</b> que con seis a medio hacer. ▸ Por qué las otras: la <b>a</b> describe un esquema de puntos por inciso que en el final no existe (sí aparece, en cambio, en el ejercicio suelto de <b>2025</b>, que ya puntúa por ítem con 3 p, pero eso es un parcial); la <b>b</b> se inventa una conversión que no está en ninguna hoja; la <b>c</b> es el consejo opuesto al correcto: dejar tres en blanco y tres impecables es exactamente la estrategia que aprueba.'},
...
registerExercises('fisica1-utn', '4', [
  ...
  {st: 'Un cilindro de radio exterior R tiene una cuerda enrollada en un <b>eje interior de radio r</b>, y se tira de la cuerda. ¿Cómo escribís el torque de la tensión y el vínculo cinemático?',
   ...
   ex: 'El molde del <b>yo-yo</b> aparece en 8 ejercicios del corpus y es donde más gente se cae. El torque se calcula con el <b>brazo</b>, que es la distancia perpendicular del eje de giro a <b>la recta de acción de la fuerza</b>: si la cuerda sale del eje de radio <span class="m">r</span>, el brazo es <span class="m">r</span>. Y hay <b>dos vínculos distintos que conviven</b>: el centro avanza a <span class="m">a<sub>CM</sub> = α R</span> (rodadura, con el radio exterior) y la cuerda se desenrolla del carrete a <span class="m">α r</span>. ▸ <b>Ojo con el segundo</b>: la aceleración del <i>extremo</i> de la cuerda (el bloque que cuelga, tu mano) es <span class="m">a<sub>cuerda</sub> = α r</span> solo si la cuerda sale <b>perpendicular</b> al desplazamiento del centro —cuerda vertical con el cilindro rodando en horizontal, que es el dibujo de la sección— o si el eje del cilindro está fijo. Si la cuerda es <b>paralela al piso</b> y además rueda, los dos movimientos se suman: <span class="m">a<sub>cuerda</sub> = a<sub>CM</sub> ± α r = α(R + r)</span> si sale por arriba del eje interior y <span class="m">α(R − r)</span> si sale por abajo. Es el B1 de 2016 (cuerda enrollada en el radio exterior, tirando por arriba: <span class="m">a<sub>bloque</sub> = 2 a<sub>CM</sub></span>), donde el propio enunciado te avisa «note que ambas son distintas». El <b>brazo del torque respecto del CM sigue siendo <span class="m">r</span> en todos los casos</b>. Lo mismo pasa cuando hay una polea con masa: <span class="m">a<sub>cuerda</sub> = α R<sub>polea</sub></span>, con el radio <i>de la polea</i>. ▸ Y no te olvides de <b>Steiner</b> si elegís tomar torques respecto del punto de contacto en vez del CM: <span class="m">I = I<sub>CM</sub> + m d²</span>. ▸ Por qué las otras: la <b>a</b> usa el radio exterior para la cuerda y es el error típico — te sobreestima el torque en un factor <span class="m">R/r</span>; la <b>b</b> inventa una resta de radios que no tiene sentido geométrico; la <b>d</b> tiene los dos radios cruzados, que es la peor combinación posible: mal el torque <i>y</i> mal el vínculo.'},
  ...
  {st: 'Las dos trampas del resorte, en el mismo examen. <b>(i)</b> Un bloque llega con velocidad v y comprime un resorte: te piden la <b>compresión máxima</b>. <b>(ii)</b> Una masa m cuelga de un resorte de constante k y longitud natural l₀ y oscila: te piden la <b>amplitud</b>. ¿Qué condición imponés en (i) y desde dónde medís en (ii)?',
   ...
   ex: 'Son dos confusiones distintas y las dos nacen de <b>elegir mal el punto de referencia</b>. <b>(i)</b> «Compresión máxima» y «equilibrio» son <b>puntos distintos</b>: donde <span class="m">v = 0</span> el resorte está máximamente comprimido y la fuerza es <b>máxima</b>; donde <span class="m">ΣF = 0</span> está el equilibrio, y ahí la <b>velocidad es máxima</b>. Justo al revés uno del otro. La compresión máxima se saca por <b>energía</b>: toda la cinética inicial (menos lo que se comió el rozamiento) se convirtió en <span class="m">½ k x²</span>. Es la trampa que gobierna los 9 ejercicios de energía con resorte. <b>(ii)</b> Si medís <span class="m">x</span> desde <span class="m">l<sub>eq</sub> = l₀ + mg/k</span>, la ecuación de movimiento queda <span class="m">m ẍ = −k x</span>: <b>el peso se fue</b>, porque su único efecto fue correr el centro de oscilación. De ahí sale la conclusión potente: <b>el MAS vertical tiene exactamente la misma frecuencia que el horizontal</b>. Y la <b>amplitud se mide desde l<sub>eq</sub></b>, nunca desde <span class="m">l₀</span> — es la trampa que define el arquetipo del MAS vertical (7 de los 9 ejercicios de oscilaciones). ▸ Por qué las otras: la <b>b</b> se come las dos, y en (i) te da la <b>posición de equilibrio</b> —justo donde la velocidad es máxima— en vez de la compresión máxima, con una trampa extra en el número: en el molde del corpus el resorte es <b>horizontal</b> contra una pared, el peso lo cancela la normal y no entra en la ecuación, así que <span class="m">ΣF = 0</span> no te da <span class="m">mg/k</span> sino <span class="m">x = 0</span> (o la deformación que equilibra al rozamiento, si lo hay); el <span class="m">mg/k</span> sale sólo cuando el peso tira <i>sobre el eje del resorte</i> —resorte vertical, o resorte horizontal tirado por una masa que cuelga de una polea—, y ahí, <b>si se suelta en reposo desde la longitud natural</b>, la máxima da <span class="m">2mg/k</span>, <b>exactamente el doble</b> de la de equilibrio (si además llega con velocidad, la cinética entra en el balance —<span class="m">½mv² + mgx = ½kx²</span>— y la máxima es mayor); la <b>c</b> acierta (i) pero mide la amplitud desde la referencia equivocada e inventa un término en <span class="m">ω</span> que no existe; la <b>d</b> acierta la referencia de (ii) pero cae en el error conceptual central —<b>la gravedad no entra en ω</b>, y sumarle un término te da un período más corto que el real— y además equivoca (i).'},
  ...
  {st: 'Dos detalles de dos problemas distintos del mismo final: (i) el enunciado de óptica dice «se obtiene una imagen <b>real</b>, <b>tres veces mayor</b>, proyectada sobre una pantalla»; (ii) el de fluidos te da la <b>profundidad</b> a la que está sumergido un cuerpo. ¿Cómo los tratás?',
   ...
   ex: 'Dos distractores clásicos, uno por tema. <b>Óptica</b>: «real» y «proyectada sobre una pantalla» son sinónimos de <b>invertida</b>, y una imagen invertida tiene <b>aumento negativo</b>. Si escribís <span class="m">m = +3</span> te queda <span class="m">x′ = −3x</span>, o sea imagen <b>virtual, detrás del espejo</b> — justo lo único que <i>no</i> se puede proyectar sobre una pantalla. En el problema del final (pantalla a 2 m del objeto) eso te da <span class="m">x = 0,5 m</span> y <span class="m">x′ = −1,5 m</span> en vez de <span class="m">x = 1 m</span> y <span class="m">x′ = 3 m</span>. ▸ Cuidado con el control falso: <b>la focal no te avisa</b> — con los dos signos sale <span class="m">f = +0,75 m</span>, cóncavo. El control que sí sirve es el otro: si la imagen va a una pantalla, <span class="m">x′</span> tiene que darte <b>positivo</b>. Y un convexo con objeto real nunca puede dar una imagen tres veces mayor: siempre la da virtual y más chica. <b>Fluidos</b>: en <span class="m">E = ρ<sub>líq</sub> V<sub>desp</sub> g</span> <b>no aparece h por ningún lado</b>. Dos cuerpos idénticos, uno a 20 cm y otro a 3 m, reciben <b>el mismo empuje</b>. Lo que sí crece con la profundidad es la <b>presión</b> (<span class="m">p = p₀ + ρ g h</span>), y por eso el enunciado te da <span class="m">h</span>: la necesitás para <i>la otra</i> pregunta del problema, no para el empuje. ▸ Por qué las otras: la <b>a</b> se come las dos trampas juntas; la <b>b</b> acierta el empuje pero pierde el signo del aumento; la <b>d</b> acierta el signo pero cae en la confusión presión/empuje — que la presión sea mayor abajo es cierto, pero el empuje es la <i>resultante</i> de las presiones sobre todas las caras, y esa diferencia depende del <b>volumen</b>, no de la profundidad.'}
...
registerExercises('fisica1-utn', '5', [
  ...
  {st: 'Un satélite de masa m orbita en círculo un planeta de masa M a una distancia r del centro. ¿Cómo sacás la velocidad de la órbita?',
   opts: [
     'Con conservación de energía: ½ m v² = m g r, así que v = √(2 g r)',
     'Igualando la atracción gravitatoria a la fuerza centrípeta: G M m / r² = m v² / r, y de ahí v = √(GM/r) — la masa del satélite se cancela',
     'Con v = ω r, donde ω sale de la frecuencia de rotación del planeta',
     'No se puede sin conocer m: cuanto más pesado el satélite, más rápido tiene que ir'
   ], c: 1,
   ex: 'Este es <b>el renglón</b> del que salen casi todos los problemas de órbita. La lógica es la de siempre en movimiento circular: la resultante apunta al centro y vale <span class="m">m v²/r</span>; acá la única fuerza que hay es la gravitatoria, así que las igualás. Al cancelar una <span class="m">m</span> y una <span class="m">r</span> queda <span class="m">v = √(GM/r)</span>, y de ahí el período en dos renglones más: <span class="m">T = 2πr/v ⟹ T² = 4π² r³/(GM)</span>, que es la tercera de Kepler. ▸ Ojo con <span class="m">r</span>: es la distancia <b>entre centros</b>, o sea <span class="m">R<sub>planeta</sub> + h</span>, no la altura. ▸ Por qué las otras: la <b>a</b> usa <span class="m">mgh</span> a escala planetaria, donde <span class="m">g</span> ya no es constante, y además mezcla energía con una condición dinámica; la <b>c</b> confunde la rotación del <i>planeta</i> sobre su eje con la traslación del satélite — solo coinciden en el caso particular de la órbita geoestacionaria, y eso es un dato del problema, no una fórmula; la <b>d</b> es justo lo contrario de lo que dice la cuenta: <span class="m">m</span> se cancela, la velocidad de órbita no depende de qué orbita. Si el enunciado te da la masa del satélite, es para la energía o es relleno.'},

  {st: 'La energía potencial gravitatoria se escribe U = − G M m / r. ¿Por qué el signo menos, y por qué no alcanza con mgh?',
   opts: [
     'El menos indica que la fuerza es de repulsión, y mgh es la versión para cuerpos livianos',
     'Es un error de imprenta frecuente: la correcta es U = + G M m / r',
     'El cero de U se elige en el infinito, así que todo estado ligado queda por debajo de cero; y mgh es solo la aproximación cerca de la superficie, donde g se puede tomar constante',
     'El menos aparece porque la altura se mide hacia abajo, y mgh sirve igual mientras uses g = 10'
   ], c: 2,
   ex: 'Es una <b>elección de referencia</b>, no una rareza: se pone <span class="m">U = 0</span> en <span class="m">r → ∞</span> (dos cuerpos infinitamente separados, sin interacción), y como acercarlos libera energía, cualquier separación finita da un número negativo. Por eso «estar ligado» es exactamente <span class="m">E = K + U &lt; 0</span>, y la velocidad de escape sale de pedir <span class="m">E = 0</span>. ▸ Y <span class="m">mgh</span> no es otra fórmula: es <b>esta misma</b>, linealizada cerca de la superficie, donde <span class="m">r</span> cambia poquito y <span class="m">g = GM/R²</span> se puede tratar como constante. Sirve para una piedra que sube 20 m; no sirve para subir un satélite de la superficie a una órbita. ▸ Por qué las otras: la <b>a</b> lee mal el signo — la gravedad es siempre atractiva, el menos es del <i>potencial</i>, no de la fuerza; la <b>b</b> rompe la física, con <span class="m">U</span> positiva y decreciente hacia afuera los cuerpos se alejarían solos; la <b>d</b> inventa una convención de alturas y después vuelve a caer en usar <span class="m">mgh</span> justo donde no vale. ▸ Y el recordatorio de la unidad: gravitación no cayó en ningún final del corpus con enunciado completo, así que esto lo sabés <b>después</b> de tener rígido, oscilaciones y choques.'}
